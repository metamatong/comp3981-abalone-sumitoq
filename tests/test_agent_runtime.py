...
from abalone.ai.minimax import TT_MODE_QUIESCENCE, _make_tt_key, _quiescence
...
class AgentRuntimeTests(unittest.TestCase):
    ...
    def test_quiescence_depth_from_agent_definition_can_be_overridden_to_zero(self):
        ...
        self.assertEqual(plain.move.to_notation(), "2:e3-f3>NE")
        self.assertEqual(quiet.move.to_notation(), "2:i9g7")
